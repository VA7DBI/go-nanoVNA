// Example: Basic NanoVNA usage
//
// This example demonstrates how to auto-detect, connect, and run a sweep on a NanoVNA device.
// It prints hardware info, capabilities, and the first 5 S11 measurement points.
//
// Usage:
//
//	go run basic.go
//
// Requires a NanoVNA device connected via USB/serial.
package main
